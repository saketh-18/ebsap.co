...
export default function Banner() {
  ...
  return (
    <div className='w-full banner1 flex justify-between'>
        <div className='w-96 h-2/3 log-in-box self-center rounded-md ml-8 flex flex-col justify-center items-center'>
      ...
      <p className='text-sky-500 text-3xl ml-2 font-semibold'>EBS AP</p>
            ...
            <input placeholder='username' value={password} onChange={(e) => {setPassword(e.target.value)}} type='password' required className='p-2 rounded-md focus:outline-none mb-3'/>
